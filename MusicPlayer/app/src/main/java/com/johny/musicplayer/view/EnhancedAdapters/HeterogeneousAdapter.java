...
public class HeterogeneousAdapter extends RecyclerView.Adapter<EnhancedViewHolder> {
     ...
     * @see com.johny.musicplayer.view.EnhancedAdapters.HeterogeneousAdapter.ListSection
     * @see com.johny.musicplayer.view.EnhancedAdapters.HeterogeneousAdapter.SingletonSection
     */
