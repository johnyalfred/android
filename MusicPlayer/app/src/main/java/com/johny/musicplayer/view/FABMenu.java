...
public class FABMenu extends FloatingActionButton implements View.OnClickListener {
    ...
    public void addChild(@DrawableRes int icon, View.OnClickListener onClickListener, String label) {
        children.add(buildChild(icon, onClickListener, label));
        labels.add(buildChildLabel(label));
    }

    public void addChild(@DrawableRes int icon, View.OnClickListener onClickListener,
                         @StringRes int label) {
    ...
    private FloatingActionButton buildChild(@DrawableRes int icon,
                                            final View.OnClickListener onClickListener, String label) {
