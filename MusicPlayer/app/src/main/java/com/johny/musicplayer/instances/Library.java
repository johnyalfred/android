package com.johny.musicplayer.instances;
...
import com.johny.musicplayer.Player;
...
public final class Library {
    ...
    public static final String PLAY_COUNT_FILE_COMMENT =
            "This file contains play count information for JMusic and should not be edited";
    ...
    /**
     * In certain cases like in {@link com.johny.musicplayer.fragments.PlaylistFragment}, editing the
    ...
    public static List<Playlist> scanPlaylists(Context context) {
        ...
        for (Playlist p : scanAutoPlaylists(context)) {
            if (playlists.remove(p)) {
                ...
                // If AutoPlaylists have been deleted outside of JMusic, delete its configuration
    ...
    /**
     * * Returns the last time a song was played with JMusic. Note that you may need to call
     * {@link Library#loadPlayCounts(Context)} in case the data has gone stale
     * @param songId The {@link Song#songId} as written in the MediaStore
